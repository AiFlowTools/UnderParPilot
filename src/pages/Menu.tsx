...
import {
  ...
  ShoppingBag, ChevronUp, ChevronRight
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-32">
      <Header
        ...
        className={`cursor-pointer hover:opacity-90 transition-all duration-300 ${headerShadow ? 'shadow-md' : ''}`}
      />
          ...
          {filteredItems.map(item => (
            <MenuItemCard
              ...
              onClick={() => {
                ...
                setIsCartOpen(false); // auto-close cart on detail view
              }}
            />
          ))}
        </div>
